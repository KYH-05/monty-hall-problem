...
for k in range(0,size):
  ...
  success_change[i]=success_change[i]/repeat[i]*100
  success_notchange[i] = success_notchange[i] / repeat[i]*100
...
plt.plot(x, y1,color='blue',linewidth=0.5)
plt.plot(x, y2,color='orange',linewidth=0.5)
